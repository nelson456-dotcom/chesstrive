...
const whyChessStrive = [
  {
    title: 'Cutting-Edge Tools',
    description: 'From live engine analysis to interactive opening trainers, Chess Strive offers the most advanced tools for chess improvement.',
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-32">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-green-400 bg-clip-text text-transparent">Chess Strive</span>
              <br />
