          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Chess Strive was born from a simple observation: traditional chess training methods often fail to 
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Join thousands of players who are already improving their game with Chess Strive's intelligent training system.
            </p>
