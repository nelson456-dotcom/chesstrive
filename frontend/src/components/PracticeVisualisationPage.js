    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-3 sm:p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">
          ...
          {/* User Rating Display */}
          {userRating && (
            <div className="inline-flex items-center bg-gradient-to-r from-teal-50 to-teal-100 px-4 sm:px-6 py-2 sm:py-3 rounded-xl border border-teal-200 shadow-lg">
                ...
                {!hidden ? (
                  <>
                    ...
                    <div className="relative w-full flex justify-center">
                      <div className="w-full max-w-full bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-2 sm:p-4 shadow-inner border border-amber-200">
                        <div className="bg-gradient-to-br from-amber-100 to-orange-100 rounded-xl p-1 sm:p-2 shadow-lg flex justify-center">
                          <Chessboard 
                            position={fen} 
