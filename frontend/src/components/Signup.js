...
import { Crown, User, Mail, Lock, Eye, EyeOff, UserPlus, ArrowRight, CheckCircle } from 'lucide-react';
      ...
      <div className="relative max-w-lg w-full">
        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-blue-900/80 backdrop-blur-xl border border-blue-500/30 rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Join Chess Strive</h2>
