...
async function analyzePositionWithAPI(fen, retries = 2) {
...
async function findWinningPositions() {
  try {
    ...
    let validCount = 0;
    const TARGET_COUNT = 1000; // Process 1000 positions from CSV
    ...
    // Process positions one by one to avoid overwhelming the API
    const positions = [];
