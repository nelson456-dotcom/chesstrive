...
const BoardTestPage = () => {
  ...
  const makeRandomMove = () => {
    if (!game || typeof game.moves !== 'function') {
      console.error('Game object is not properly initialized');
      return;
    }
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Turn:</strong> {game && typeof game.turn === 'function' ? (game.turn() === 'w' ? 'White' : 'Black') : 'Unknown'}</p>
                <p><strong>Moves:</strong> {game && typeof game.history === 'function' ? game.history().length : 0}</p>
                <p><strong>Status:</strong> {
                  game && typeof game.isCheckmate === 'function' ? (
