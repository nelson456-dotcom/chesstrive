              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center">
                    <Icons8Icons.Mail className="h-6 w-6 text-white" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center">
                    <Icons8Icons.MessageCircle className="h-6 w-6 text-white" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center">
                    <Icons8Icons.Phone className="h-6 w-6 text-white" />
                  </div>
                  <div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a href="#" className="flex items-center space-x-3 p-4 bg-gray-700 rounded-xl hover:bg-gray-600 transition-colors">
                  <Icons8Icons.Facebook className="h-6 w-6 text-blue-400" />
                  <span>Facebook</span>
                </a>
                <a href="#" className="flex items-center space-x-3 p-4 bg-gray-700 rounded-xl hover:bg-gray-600 transition-colors">
                  <Icons8Icons.Twitter className="h-6 w-6 text-blue-400" />
                  <span>Twitter</span>
                </a>
                <a href="#" className="flex items-center space-x-3 p-4 bg-gray-700 rounded-xl hover:bg-gray-600 transition-colors">
                  <Icons8Icons.Instagram className="h-6 w-6 text-pink-400" />
                  <span>Instagram</span>
                </a>
                <a href="#" className="flex items-center space-x-3 p-4 bg-gray-700 rounded-xl hover:bg-gray-600 transition-colors">
                  <Icons8Icons.Linkedin className="h-6 w-6 text-blue-400" />
                  <span>LinkedIn</span>
                </a>
              </div>
            </div>
